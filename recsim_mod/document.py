...
# you may not use this file except in compliance with the License.ca
...
class CandidateSet(object):
  ...
  def shuffle(self) :
    ...
    self._documents_shuffled={key:self._documents[key] for key in keys}
    self._documents=self._documents_shuffled
